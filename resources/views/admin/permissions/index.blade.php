...
@section('content')
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="btn-group">
                <a href="{{ route(auth()->user()->getRoleNames()->first() . '.roles.index') }}"
                        ...
                        <tbody>
                            @foreach ($permissions as $permission)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge {{ $permission->guard_name == 'web' ? 'bg-info text-dark' : ($permission->guard_name == 'app' ? 'bg-warning text-dark' : 'bg-secondary') }}">
