            ...
            <form action="{{ route(auth()->user()->getRoleNames()->first().'.projects.store') }}" method="POST">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <label class="f-label">Base Amount (₹) <span class="req">*</span></label>
                            <input type="number" name="base_amount" id="base_amount" class="f-input" value="{{ old('base_amount') }}" placeholder="e.g. 150000" required oninput="calculateTotal()">
                        </div>
                        <div class="col-md-2 mb-3">
                            <label class="f-label">Discount Type</label>
                            <select name="discount_type" id="discount_type" class="f-select" onchange="calculateTotal()">
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="number" name="discount_value" id="discount_value" class="f-input" value="{{ old('discount_value', 0) }}" placeholder="0" oninput="calculateTotal()">
                        </div>
                        <div class="col-md-2 mb-3">
                            <label class="f-label">Discount Amount (₹)</label>
                            <input type="number" id="discount_amount_disp" class="f-input" readonly value="0" style="background: #f8fafc;">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label class="f-label" style="color: #166534;">Final Total Amount (₹)</label>
                            <input type="number" name="total_amount" id="total_amount" class="f-input" value="{{ old('total_amount') }}" readonly style="background: #f0fdf4; border-color: #bbf7d0; color: #166534; font-weight: 800;">
                        </div>
                    </div>
                    <div class="amount-grid mt-3">
                        <div>
                        ...
                        <div>
                            <label class="f-label">Part Payment / Booking (₹)</label>
                ...
                <script>
                    function calculateTotal() {
                        ...
                        document.getElementById('discount_amount_disp').value = disc.toFixed(2);
                        document.getElementById('total_amount').value = (base - disc).toFixed(2);
                    }
                </script>
