            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto mb-2">
                    @can('discount-offers.create')
                        <a href="{{ route(auth()->user()->getRoleNames()->first() . '.discount-offer.create') }}"
                            class="btn btn-primary">
                            <i class="fas fa-plus"></i> Create New Rule
                        </a>
                    @endcan
                    {{-- <a href="{{ route(auth()->user()->getRoleNames()->first() . '.discount-offer.pending') }}"
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            @can('discount-offers.delete')
                                                <form
                                                    action="{{ route(auth()->user()->getRoleNames()->first() . '.discount-offer.destroy', $discount) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center text-muted py-4">
                                        ...
                                        @can('discount-offers.delete')
                                            <a
                                                href="{{ route(auth()->user()->getRoleNames()->first() . '.discount-offer.create') }}">Create
                                                your first rule</a>
                                        @endcan
                                    </td>
                                </tr>
