    ...
    <div class="container-fluid mt-4">
        ...
        <div class="page-header mb-3">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Create Discount Rule</h3>
            ...
            <div class="col-lg-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Create Item Date</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route(auth()->user()->getRoleNames()->first() .'.discount-offer.store') }}" method="POST">
                            @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('discount_type') is-invalid @enderror"
                                            ...
                                            <option value="fixed_amount"
                                                {{ old('discount_type') == 'fixed_amount' ? 'selected' : '' }}>Fixed Amount
                                            </option>
                                        </select>
                                        @error('discount_type')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="applicable_to" name="applicable_to" value="{{ old('applicable_to') }}"
                                ...
                                <div class="col-12 mt-3">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                            rows="3" placeholder="Discount description..." required>{{ old('description') }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('repeat') is-invalid @enderror" id="repeat"
                                            name="repeat">
                                            <option value="none" {{ old('repeat') == 'none' ? 'selected' : '' }}>No
                                                Repeat</option>
                                            <option value="daily" {{ old('repeat') == 'daily' ? 'selected' : '' }}>Daily
                                            </option>
                                            <option value="weekly" {{ old('repeat') == 'weekly' ? 'selected' : '' }}>
                                                Weekly</option>
                                            <option value="monthly" {{ old('repeat') == 'monthly' ? 'selected' : '' }}>
                                                Monthly</option>
                                            <option value="yearly" {{ old('repeat') == 'yearly' ? 'selected' : '' }}>
                                                Yearly</option>
                                        </select>
                                        @error('repeat')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                ...
                                <div class="col-12 mt-3">
                                    <div class="form-check mb-3">
                                        ...
                                        <label class="form-check-label" for="requires_approval">
                                            Requires Approval (Rule will be pending until approved by admin)
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-right mt-3">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Create Discount Rule
                                </button>
                            </div>
                        </form>
                    </div>
